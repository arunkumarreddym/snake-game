...
public class GamePanel extends JPanel implements ActionListener {
    ...
    public void startGame() {
        ...
        score = 0;
        snake.clear();
        snake.add(new Point(5, 5)); // Reset snake position
        placeApple();
    ...
    public void gameOver(Graphics g) {
        ...
        g.drawString("Game Over! Press R to Restart", WIDTH / 2 - g.getFontMetrics().stringWidth("Game Over! Press R to Restart") / 2, HEIGHT / 2);
        g.drawString("Final Score: " + score, WIDTH / 2 - g.getFontMetrics().stringWidth("Final Score: " + score) / 2, HEIGHT / 2 + 20);

        if (score < 10) {
            g.drawString("Noob!", WIDTH / 2 - g.getFontMetrics().stringWidth("Noob!") / 2, HEIGHT / 2 + 40);
        }
    }
    ...
    public void showPauseMenu(Graphics g) {
        ...
        g.setColor(Color.WHITE);
        g.drawString("Game Paused: Press P to Resume", WIDTH / 2 - g.getFontMetrics().stringWidth("Game Paused: Press P to Resume") / 2, 20);
    }
